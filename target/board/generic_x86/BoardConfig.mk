...
# For mrst_ref
BOARD_KERNEL_CMDLINE := init=/init console=tty0 androidboot.hardware=generic_x86 pci=noearly earlyprintk=mrst notsc no_percpu_apbt s0ix_latency=160
TARGET_USE_DISKINSTALLER := false

# For VirtualBox and likely other emulators, uncomment the below
