...
$(info ************************************************************)
$(info Your version of javac is: $(shell javac -version 2>&1 | head -n 1).)
$(info $(space))
$(info OverrideCheck will be run on java source)
$(info in order to check for javac 1.5 compatibility)
$(info ************************************************************)
