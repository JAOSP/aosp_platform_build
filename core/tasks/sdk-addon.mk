...
files_to_copy += \
        $(BUILT_SYSTEMIMAGE):images/$(TARGET_ARCH)/system.img \
        $(BUILT_USERDATAIMAGE_TARGET):images/$(TARGET_ARCH)/userdata.img \
        $(BUILT_RAMDISK_TARGET):images/$(TARGET_ARCH)/ramdisk.img \
        $(target_notice_file_txt):images/$(TARGET_ARCH)/NOTICE.txt
