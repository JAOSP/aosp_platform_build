...
$(strip \
    ...
    $(eval _idf2ndArch := $(if $(call directory_is_64_bit_blacklisted,$(LOCAL_PATH)),true,$(strip $(5)))) \
    $(eval _idfClass := $(strip $(1))) \
    $(eval _idf2ndArchPrefix := $(if $(call directory_is_64_bit_blacklisted,$(LOCAL_PATH)),$(TARGET_2ND_ARCH_VAR_PREFIX),$(if $(strip $(5)),$(TARGET_2ND_ARCH_VAR_PREFIX)))) \
