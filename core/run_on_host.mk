...
$(LOCAL_MODULE)-run-on-host: PRIVATE_RUN_ON_HOST_DEPS := $(RUN_ON_HOST_DEPS)
...
$(LOCAL_MODULE)-run-on-host-prepare: $(LOCAL_MODULE) $(TARGET_OUT_EXECUTABLES)/$(LINKER) $(TARGET_OUT_EXECUTABLES)/sh $(PRIVATE_RUN_ON_HOST_DEPS)
