...
TARGET_OUT_VENDOR_UNSTRIPPED := $(TARGET_OUT_UNSTRIPPED)/$(TARGET_COPY_OUT_VENDOR)
TARGET_OUT_VENDOR_EXECUTABLES_UNSTRIPPED := $(TARGET_OUT_VENDOR_UNSTRIPPED)/bin
TARGET_OUT_VENDOR_SHARED_LIBRARIES_UNSTRIPPED := $(TARGET_OUT_VENDOR_UNSTRIPPED)/lib
