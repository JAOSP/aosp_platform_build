...
my_target_global_cflags := $(call get-clang-global-flags,CFLAGS)
my_target_global_cppflags := $(call get-clang-global-flags,CPPFLAGS)
my_target_global_ldflags := $(call get-clang-global-flags,LDFLAGS)
...
ifeq ($(LOCAL_CLANG),true)
my_host_global_cflags := $(call get-clang-host-global-flags,CFLAGS)
my_host_global_cppflags := $(call get-clang-host-global-flags,CPPFLAGS)
my_host_global_ldflags := $(call get-clang-host-global-flags,LDFLAGS)
