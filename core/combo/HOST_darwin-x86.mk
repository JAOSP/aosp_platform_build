...
host_toolchain_dir := prebuilts/gcc/darwin-x86/host/i686-apple-darwin-4.2.1
host_toolchain_prefix := $(host_toolchain_dir)/bin/i686-apple-darwin$(gcc_darwin_version)
...
host_toolchain_header := $(host_toolchain_dir)/lib/gcc/i686-apple-darwin$(gcc_darwin_version)/4.2.1/include
